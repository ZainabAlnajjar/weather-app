...
val humidityItem =
    DetailsItem(value = humidityValueWithUnit, title = "Humidity", imageId = R.drawable.icon_humidity)
val rainItem = DetailsItem(value = rainValueWithUnit, title = "Rain", imageId = R.drawable.icon_rain)
val uvItem = DetailsItem(value = uvIndexValueWithUnit, title = "UV Index", imageId = R.drawable.icon_uv)
val pressureItem =
    DetailsItem(value = pressureValueWithUnit, title = "Pressure", imageId = R.drawable.icon_pressure)
val temperatureItem =
    DetailsItem(value = temperatureValueWithUnit, title = "Feels like", imageId = R.drawable.icon_temperature)
